...
/**
 * Next 16 replaced the `middleware` file convention with `proxy` — same
 * request interception, new name and new required export. The old convention
 * still builds but logs a deprecation warning.
 */
